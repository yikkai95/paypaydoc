...
- `research/` — topic-specific research notes and drafts.
- `proposal/` — proposals, solution options, and client-facing drafts.
...
- `meetings/2026-03-12.md` — Network School follow-up note for the `USDC permit() + Gnosis Safe multisig` demo.
- `proposal/README.md` — notes on what belongs in the proposal folder.
